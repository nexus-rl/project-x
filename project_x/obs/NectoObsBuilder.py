...
from project_x.obs.BatchedObsBuilder import BatchedObsBuilder
from project_x.utils.gamestate_encoding import encode_gamestate
from project_x.utils.gamestate_encoding import StateConstants as SC
...
class NectoObsBuilder(BatchedObsBuilder):
    ...
    def __init__(self, env: Gym = None, n_players=6, tick_skip=8):
        super().__init__()
        self.env = env
